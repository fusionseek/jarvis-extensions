...
| 03 | [manifest 规范](03-manifest.md) | `extension.json` 逐字段：四个部分怎么写、跨字段规则、校验 |
...
| 07 | [UI 组件目录](07-ui-components.md) | 30 种节点与宿主实现的逐项对应、全局规则 |
...
| 12 | [开发手册](12-developer-guide.md) | 六步：脚手架 → manifest → 代码 → 构建校验 → 开发者模式 → PR |
